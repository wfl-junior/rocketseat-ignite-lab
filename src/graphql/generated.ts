...
export function useLessonBySlugQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<LessonBySlugQuery, LessonBySlugQueryVariables>(
    LessonBySlugDocument,
    options
  );
}
export function useLessonBySlugLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<LessonBySlugQuery, LessonBySlugQueryVariables>(
    LessonBySlugDocument,
    options
  );
}
export type LessonBySlugQueryHookResult = ReturnType<
  typeof useLessonBySlugQuery
>;
export type LessonBySlugLazyQueryHookResult = ReturnType<
  typeof useLessonBySlugLazyQuery
>;
export type LessonBySlugQueryResult = Apollo.QueryResult<
  LessonBySlugQuery,
  LessonBySlugQueryVariables
>;
